  ...
  return (
    <div className="bg-[#1B1613] border border-[#2E271F] rounded-[14px] p-5 flex flex-col justify-between space-y-4 hover:border-[#8A7238] transition-colors duration-200 group">
      <div className="space-y-3.5">
        ...
        {/* 2. Hotel Name (Serif font, ~25px, warm cream) */}
        ...
        <div className="p-3.5 rounded-xl bg-[#17130F] border border-[#2E271F] flex items-center justify-between gap-2">
          <div>
      ...
      {/* 8. Single CTA Button: Full width, gold bg, dark text (#1B1613), rounded pill, "View details" */}
      <button
