...
/**
 * Place Details Master Orchestrator for Prayagraj.
 *
 * @param {Object} props
  ...
  return (
    <article className="space-y-8 pb-16">
      ...
      <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-xs font-mono text-text-low pt-2">
        ...
        >
          <ChevronLeft size={14} />
          <span>Prayagraj Destinations</span>
        </Link>
        <span>/</span>
      ...
      <PlaceCrowdTelemetryCard place={place} city="prayagraj" />
