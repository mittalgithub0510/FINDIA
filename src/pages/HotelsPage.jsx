...
import { Sparkles, Building, ChevronLeft } from '../components/icons';
    ...
    <div className="min-h-screen bg-bg-base text-text-high flex items-center justify-center p-6">
      <div className="max-w-lg w-full glass-heavy p-8 sm:p-10 rounded-3xl border border-white/15 text-center space-y-6 shadow-lifted">
        ...
        <div className="space-y-2">
          ...
          <h1 className="type-h1 font-display font-bold">Hotels & Heritage Stays</h1>
          <p className="text-sm text-text-mid leading-relaxed">
            Curated heritage boutique hotels, havli stays, and crowd-aware accommodations across India coming soon in the next release.
          </p>
        </div>
